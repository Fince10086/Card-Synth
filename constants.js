    ...
    sources: [
      {
        ...
        volume: -6,
        pan: -0.18,
        options: { type: "sine", modulationType: "square", harmonicity: 2.3, modulationIndex: 18 },
      ...
      },
      {
        ...
        volume: -12,
        pan: 0.22,
        options: { harmonicity: 1.2, type: "triangle", modulationType: "sine" },
    ...
    sources: [
      {
        ...
        volume: -8,
        pan: -0.22,
        options: { type: "triangle", modulationType: "sine", harmonicity: 0.75 },
  ...
  percussionLab: {
    ...
    sources: [
      ...
      },
      {
        ...
        volume: -12,
        pan: 0.18,
        options: { type: "brown", playbackRate: 1 },
